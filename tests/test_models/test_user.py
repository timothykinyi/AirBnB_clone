...
class TestUserInstantiation(unittest.TestCase):
    ...
    def test_user_has_profile_picture(self):
        us = User()
        self.assertFalse(hasattr(us, 'profile_picture'))
        us.profile_picture = 'avatar.jpg'
        self.assertEqual(us.profile_picture, 'avatar.jpg')

    def test_user_can_have_multiple_roles(self):
        us = User()
        self.assertFalse(hasattr(us, 'roles'))
        us.roles = ['admin', 'editor']
        self.assertEqual(us.roles, ['admin', 'editor'])
...
class TestUserSave(unittest.TestCase):
    ...
    def test_save_user_with_roles(self):
        us = User()
        us.roles = ['admin', 'editor']
        us.save()
        usid = "User." + us.id
