...
class TestStateInstantiation(unittest.TestCase):
    ...
    def test_population_is_public_class_attribute(self):
        st = State()
        self.assertEqual(int, type(State.population))
        self.assertIn("population", dir(st))
        self.assertNotIn("population", st.__dict__)
